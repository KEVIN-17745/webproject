...
<div class="app-main__outer">
                    <div class="app-main__inner">
                        <div class="app-page-title">
                            ...
                            <div class="row">
                            <div class="col-sm-8"><h4>Announcements <b>details</b> </h4></div>
                    <div class="col-sm-4">
                        <a href="{{url('admin/add-edit-announcement')}}" style="max-width:150px; float:right; display:inline-block;" class="btn btn-block btn-success">Add New </a>                    </div>
                </div>
                            <div class="col-lg-12">
...
@endif
                                    <div class="card-body"><h5 class="card-title">Table </h5>
